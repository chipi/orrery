import{B as e,X as t,b as n,bt as r,ct as i,q as a,st as o}from"./7sssqGyv.js";function s(e){return e<700?{scale:2.15,yOffset:-.55}:{scale:1,yOffset:0}}function c(e){switch(e){case`cinematic`:return 260;case`high`:return 220;case`medium`:return 185;default:return 155}}var l=`
  out vec2 vUv;
...
`;function d(d,f=`high`){let p=new o,m=new a(-1,1,1,-1,0,1),h=2.6-.8*Math.min(1,Math.max(0,d.spin)),g=1+Math.min(4,d.inclination_deg*.12),_={uRes:{value:new r(1,1)},uScale:{value:1},uYOff:{value:0},uTime:{value:0},uCamY:{value:g},uDiskIn:{value:h},uCurvature:{value:0}},v=new i({glslVersion:n,uniforms:_,vertexShader:l,fragmentShader:u.replace(`STEP_COUNT`,String(c(f))),depthTest:!1,depthWrite:!1}),y=new e(new t(2,2),v);return y.frustumCulled=!1,p.add(y),{scene:p,camera:m,update(e){_.uTime.value+=e},setCurvature(e){_.uCurvature.value=Math.min(1,Math.max(0,e))},setSize(e,t,n){let r=Math.max(1,e);_.uRes.value.set(r*n,Math.max(1,t)*n);let i=s(r);_.uScale.value=i.scale,_.uYOff.value=i.yOffset},dispose(){y.geometry.dispose(),v.dispose()}}}export{d as createBlackHoleScene,c as stepsForTier};