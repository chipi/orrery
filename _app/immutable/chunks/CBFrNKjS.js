import{b as j}from"./CPwLOqZt.js";import{M as L,_ as $,g as k,$ as V,u as v,U,m as d,q as y,t as C,N as J,a0 as Z,p as E,V as M,w as ee,e as te,h as G,Q as P,I as W,X as N,G as se}from"./DsPjXTZH.js";import{_ as ie}from"./Bv6SoQKO.js";const re=.05;function ae(){return typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches}function Me(s){const e=s.maxDtSec??re,t=s.reducedMotion??ae,i=s.ignoreVisibilityPause??!1;let a=null,r=!1,o=!1,n=null,l=0;const h=()=>{o||(document.hidden?b():r&&(n=null,u()))},u=()=>{a===null&&(a=requestAnimationFrame(c))},c=f=>{if(a=null,o||!r||!i&&j&&document.hidden)return;const p=f/1e3;if(n===null){n=p,u();return}const D=p-n;n=p;const R=t()?0:Math.min(D,e);l+=R,s.onFrame({dt:R,elapsed:l}),r&&u()},g=()=>{r||o||(r=!0,n=null,u())},b=()=>{r=!1,a!==null&&(cancelAnimationFrame(a),a=null)},A=()=>{o||(o=!0,b(),i||document.removeEventListener("visibilitychange",h))};return i||document.addEventListener("visibilitychange",h),{start:g,stop:b,cleanup:A,get running(){return r}}}function Te(){const s=[];let e=!1;return{on(t,i,a,r){t.addEventListener(i,a,r);const o=typeof r=="object"?{capture:r.capture}:r;s.push(()=>t.removeEventListener(i,a,o))},add(t){s.push(t)},cleanup(){if(!e){e=!0;for(let t=s.length-1;t>=0;t--)try{s[t]()}catch(i){console.error("[route-lifecycle] teardown failed",i)}s.length=0}},get disposed(){return e}}}const _={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
