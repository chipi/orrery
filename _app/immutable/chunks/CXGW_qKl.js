import{a as e}from"./CrfDR_C6.js";import{B as t,K as n,O as r,Q as i,St as a,Z as o,b as s,bt as c,c as l,gt as u,l as d,p as f,st as p,vt as m,x as h,y as g,yt as _,z as v}from"./B5LoSy_4.js";var y=.05;function b(){return typeof window>`u`||typeof window.matchMedia!=`function`?!1:window.matchMedia(`(prefers-reduced-motion: reduce)`).matches}function x(e){let t=e.maxDtSec??y,n=e.reducedMotion??b,r=e.ignoreVisibilityPause??!1,i=null,a=!1,o=!1,s=null,c=0,l=()=>{o||(document.hidden?p():a&&(s=null,u()))},u=()=>{i===null&&(i=requestAnimationFrame(d))},d=l=>{if(i=null,o||!a||!r&&document.hidden)return;let d=l/1e3;if(s===null){s=d,u();return}let f=d-s;s=d;let p=n()?0:Math.min(f,t);c+=p,e.onFrame({dt:p,elapsed:c}),a&&u()},f=()=>{a||o||(a=!0,s=null,u())},p=()=>{a=!1,i!==null&&(cancelAnimationFrame(i),i=null)};return r||document.addEventListener(`visibilitychange`,l),{start:f,stop:p,cleanup:()=>{o||(o=!0,p(),r||document.removeEventListener(`visibilitychange`,l))},get running(){return a}}}function S(){let e=[],t=!1;return{on(t,n,r,i){t.addEventListener(n,r,i);let a=typeof i==`object`?{capture:i.capture}:i;e.push(()=>t.removeEventListener(n,r,a))},add(t){e.push(t)},cleanup(){if(!t){t=!0;for(let t=e.length-1;t>=0;t--)try{e[t]()}catch(e){console.error(`[route-lifecycle] teardown failed`,e)}e.length=0}},get disposed(){return t}}}var C={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
