import{G as $,d as E,I as O,a3 as D,a4 as I,M as U,a5 as G,K as _,t as g,U as B,j as f,o as S,p as W,q as w,a6 as J,l as C,V as b,v as Z,n as ee,e as K}from"./CUQjV209.js";import{b as te}from"./CPwLOqZt.js";import{_ as ie}from"./C1FmrZbK.js";function L({count:s=1500,radius:e=200,jitter:t=80,color:i=14542079,size:a=1,opacity:r=.55}={}){const o=new Float32Array(s*3);for(let n=0;n<s;n++){const u=e+Math.random()*t,c=Math.random()*Math.PI*2,d=Math.acos(2*Math.random()-1);o[n*3]=u*Math.sin(d)*Math.cos(c),o[n*3+1]=u*Math.sin(d)*Math.sin(c),o[n*3+2]=u*Math.cos(d)}const l=new E;return l.setAttribute("position",new O(o,3)),new D(l,new I({color:i,size:a,sizeAttenuation:!1,transparent:!0,opacity:r}))}function me({counts:s,shellRadius:e=1500}){const t=new $;return t.add(L({count:s.dim,radius:e,jitter:e*(500/1500),size:.9,opacity:.55})),t.add(L({count:s.bright,radius:e*(1400/1500),jitter:e*(600/1500),size:1.6,opacity:.95})),t.add(se(s.milkyWay,e)),t}function se(s,e){const t=e*.9666666666666667,i=e*(350/1500),a=new Float32Array(s*3);for(let o=0;o<s;o++){const l=t+Math.random()*i,n=Math.random()*Math.PI*2,u=Math.acos(2*Math.random()-1);a[o*3]=l*Math.sin(u)*Math.cos(n),a[o*3+1]=l*Math.sin(u)*Math.sin(n)*.18,a[o*3+2]=l*Math.cos(u)}const r=new E;return r.setAttribute("position",new O(a,3)),new D(r,new I({color:15788248,size:1.2,sizeAttenuation:!1,transparent:!0,opacity:.45}))}const re=.05;function ae(){return typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches}function pe(s){const e=s.maxDtSec??re,t=s.reducedMotion??ae,i=s.ignoreVisibilityPause??!1;let a=null,r=!1,o=!1,l=null,n=0;const u=()=>{o||(document.hidden?p():r&&(l=null,c()))},c=()=>{a===null&&(a=requestAnimationFrame(d))},d=X=>{if(a=null,o||!r||!i&&te&&document.hidden)return;const P=X/1e3;if(l===null){l=P,c();return}const j=P-l;l=P;const z=t()?0:Math.min(j,e);n+=z,s.onFrame({dt:z,elapsed:n}),r&&c()},h=()=>{r||o||(r=!0,l=null,c())},p=()=>{r=!1,a!==null&&(cancelAnimationFrame(a),a=null)},v=()=>{o||(o=!0,p(),i||document.removeEventListener("visibilitychange",u))};return i||document.addEventListener("visibilitychange",u),{start:h,stop:p,cleanup:v,get running(){return r}}}function ge(){const s=[];let e=!1;return{on(t,i,a,r){t.addEventListener(i,a,r);const o=typeof r=="object"?{capture:r.capture}:r;s.push(()=>t.removeEventListener(i,a,o))},add(t){s.push(t)},cleanup(){if(!e){e=!0;for(let t=s.length-1;t>=0;t--)try{s[t]()}catch(i){console.error("[route-lifecycle] teardown failed",i)}s.length=0}},get disposed(){return e}}}var y={uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
