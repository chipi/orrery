import{H as A,f as k,R as _,F as m,a4 as d,af as y,ag as o,aj as h,_ as D,w as v,i as F,j as c,J as L,m as T,K as Q,Z as V,P as C,z as G,ah as w,A as I}from"./ChrIQJ-w.js";var p={uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = opacity * texel;
				...
				}`})}getEdgeDetectionMaterial(){return new d({uniforms:{maskTexture:{value:null},texSize:{value:new o(.5,.5)},visibleEdgeColor:{value:new w(1,1,1)},hiddenEdgeColor:{value:new w(1,1,1)}},vertexShader:`varying vec2 vUv;
				...
				}`,blending:I,depthTest:!1,depthWrite:!1,transparent:!0})}}f.BlurDirectionX=new o(1,0);f.BlurDirectionY=new o(0,1);const X={edgeStrength:4,edgeGlow:.4,edgeThickness:1.5,visibleEdgeColor:5164484,hiddenEdgeColor:2247240},K={station:1200};function Y(u){const{renderer:e,scene:r,camera:a,width:t,height:s}=u,i={...X,...u.options},l=new H(e);l.setSize(t,s),l.setPixelRatio(Math.min(window.devicePixelRatio,2)),l.addPass(new W(r,a));const n=new f(new o(t,s),r,a);return n.edgeStrength=i.edgeStrength,n.edgeGlow=i.edgeGlow,n.edgeThickness=i.edgeThickness,n.visibleEdgeColor.setHex(i.visibleEdgeColor),n.hiddenEdgeColor.setHex(i.hiddenEdgeColor),l.addPass(n),{composer:l,outlinePass:n}}export{K as S,Y as c};
