import{b as J}from"./CPwLOqZt.js";import{M as L,X as Z,g as z,Y as V,J as v,U,m as d,z as y,I as C,N as ee,Z as te,v as E,V as M,Q as se,e as ie,h as G,_ as P,u as W,$ as N,G as re}from"./D7bTI-5N.js";import{_ as ae}from"./Bv6SoQKO.js";import{r as K}from"./D3EQEp_s.js";import{b as Y}from"./DbwTTcgQ.js";import"./B0XwC4Ot.js";const oe=.05;function le(){return typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches}function ye(i){const e=i.maxDtSec??oe,t=i.reducedMotion??le,s=i.ignoreVisibilityPause??!1;let a=null,r=!1,o=!1,n=null,l=0;const h=()=>{o||(document.hidden?b():r&&(n=null,u()))},u=()=>{a===null&&(a=requestAnimationFrame(c))},c=f=>{if(a=null,o||!r||!s&&J&&document.hidden)return;const p=f/1e3;if(n===null){n=p,u();return}const D=p-n;n=p;const R=t()?0:Math.min(D,e);l+=R,i.onFrame({dt:R,elapsed:l}),r&&u()},g=()=>{r||o||(r=!0,n=null,u())},b=()=>{r=!1,a!==null&&(cancelAnimationFrame(a),a=null)},A=()=>{o||(o=!0,b(),s||document.removeEventListener("visibilitychange",h))};return s||document.addEventListener("visibilitychange",h),{start:g,stop:b,cleanup:A,get running(){return r}}}function Ce(){const i=[];let e=!1;return{on(t,s,a,r){t.addEventListener(s,a,r);const o=typeof r=="object"?{capture:r.capture}:r;i.push(()=>t.removeEventListener(s,a,o))},add(t){i.push(t)},cleanup(){if(!e){e=!0;for(let t=i.length-1;t>=0;t--)try{i[t]()}catch(s){console.error("[route-lifecycle] teardown failed",s)}i.length=0}},get disposed(){return e}}}const _={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
