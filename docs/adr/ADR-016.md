...
- **Mission imagery** — NASA Images API queried per mission during build, top result per mission written to `static/images/missions/[id]/`. Scheduled rebuild (weekly) keeps active mission imagery fresh. *(scheduled for Slice 4)*
