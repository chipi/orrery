...
- The physics-terminology glossary at `docs/i18n-style-guide.md` (per ADR-017's content rules; authored under #34) is the LLM's binding brief — terms in that glossary are non-negotiable.
...
- The glossary at `docs/i18n-style-guide.md` is part of the translator brief (whether LLM or human); changes to the glossary should ideally trigger re-translation of affected files.
