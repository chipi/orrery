...
**`?view=list`** forces **list mode**: alphabetical module list, same [`IssModulePanel`](../../src/lib/components/IssModulePanel.svelte) content. **No WebGL** initialisation — no `THREE.WebGLRenderer`, no GLB fetch.
