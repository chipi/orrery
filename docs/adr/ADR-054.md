...
- Batch pipeline: `scripts/wave23/catalog.ts` → `scripts/wave23/maps.ts` → `scripts/wave23/apply-translations.ts`. Tracked in [project memory](../../../.claude/projects/-Users-markodragoljevic-Projects-orrery/memory/project_science_translation_pipeline.md).
