...
**i18n** — 2 missing event labels added (`fly_event_phasing`, `fly_event_separation`); all 17 fly_event keys present in all 14 locales (uppercase aerospace shorthand convention — EN-baseline across non-EN locales, same as TCM/EDL/ANOMALY).
