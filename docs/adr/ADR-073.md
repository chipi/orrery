...
**Layer A status: not yet shipped.** The per-region inset mechanism + the `inset_texture_path` schema field remain unimplemented as of this writing — Layer B alone gives the bulk of the perceived sharpness win; Layer A's per-region payoff lands when the showcase site insets (Apollo 11, Curiosity Bradbury Landing, LC-39A) are sourced and authored.
