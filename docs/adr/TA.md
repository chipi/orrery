...
*Orrery · Reference document · v2.9 · July 2026*
...
**Descent & landing — the closing bookend of `/fly` (RFC-034 §12 · epic Track D).** The inverse of the launch act: for the **37 Moon/Mars/Venus landers** the flight continues `arrival → descent → surface`, closing the arc `pad → orbit → cruise → arrival → descent → surface`. A 1:1 mirror of the ascent stack, built on the same three seams. Layering:
