...
6. **It is locale-aware.** Spanish, future Wave-1 languages and beyond translate with the rest of the app per ADR-017. Physics terminology follows the glossary at `docs/i18n-style-guide.md`.
