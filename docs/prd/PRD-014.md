...
- GH #107 — Stage 2 Tier 2 NASA cislunar waypoints (literal NASA-reconstructed state vectors for Apollo 11/13/17 + Artemis II vs current Tier 1 analytic shapes). v0.7.x candidate.
