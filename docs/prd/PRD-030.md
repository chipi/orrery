...
- **Phase D — physics beyond the map.** S6 black holes + curvature/time lenses; S7 property-space lenses.
- **Phase E — and beyond.** S8+ Local Group + message objects + narrated grand tour.
