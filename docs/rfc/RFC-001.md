...
> Status · Closed · superseded by ADR-013
> TA anchor · §components/router · §constraints
> Closes into · ADR-013 (History API routing via SvelteKit)
> Why this was an RFC · Hash routing was locked for v1 (ADR-004) at the time this RFC was opened, but the router's internal design — how it handles params, how screens register routes, whether to use a library or write from scratch — had genuine alternatives with real trade-offs.
