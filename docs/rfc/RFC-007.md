...
> Status · Decided · closed by ADR-026 (2026-04-29)
...
> Related ADRs · ADR-008 (Lambert worker), ADR-022 (Lambert protocol), ADR-023 (mobile magnifier), ADR-026 (this RFC's closure)
