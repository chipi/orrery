...
30-50% of large downloads). Final state: 13 of 13 Mars sites
resolved end-to-end. See
[`docs/guides/image-pipeline-v2.md`](../guides/image-pipeline-v2.md)
§"Surface Hotspots Tier 2 patches — auto-fetch" for the current
mechanics + CLI surface + two hard-won lessons + operator playbook.
