...
| Chang'e 2 Global Lunar Mosaic (Moon regional Tier 2a, v0.7.x) | CNSA archives via deduplicated tile-server endpoint (TBD per S1 of #PC) | TIFF / GeoTIFF → 2048² JPEG | → JPEG quality 88 | License CC-BY-CNSA (new license-allowlist entry per ADR-047) |
