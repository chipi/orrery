...
× 12 locales = **792 audio assets** at full hierarchy. **v0.7 ships en-US only**: 33 logical episodes × 2 providers (Google Neural2 + ElevenLabs A/B) = 66 audio assets ≈ 97 MB. The 12-locale Curator Tour (S7) moves to v0.8 with the translation pipeline (S2).
