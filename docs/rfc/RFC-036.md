...
*Status: Accepted (design) · 2026-08-05 · Closes: architectural-review R1 · builds on RFC-034 (ascent), RFC-033 (launch/live), ADR-084 (the data.ts decomposition, as the pattern precedent) · target: v0.9 · Tracking: #440 (WS-A `/fly` controller) · #441 (WS-B `/fly` scene, blocked-by #440) · #443 (WS-C `/explore`, blocked-by #440/#441)*
