...
|---|---|---|---|
| 01 | `01-tower-clear.png` | Tower-clear liftoff | thrust (green ↑) vs weight (red ↓) force vectors, `TWR` readout, volumetric plume, low-wide pad cam |
| 02 | `02-onboard-down.png` | Onboard-looking-down | strap-cam down the flank, Earth falling away, `Q` (dynamic pressure) gauge |
| 03 | `03-stage-sep.png` | Stage separation | spent booster tumbling off the lit stage against the limb, `STAGE SEP` beat |
| 04 | `04-meco-orbit.png` | MECO → cruise handoff | engine dark in parking orbit, dashed **CRUISE TRAJECTORY** arc = the seam into today's `/fly` |
