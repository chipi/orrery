...
But the Deep Space Network has one adversary it cannot argue with, and its name is the speed of light. At Mars, a command takes anywhere from four to twenty-four minutes to arrive, and the acknowledgement takes just as long to come back. At Pluto it is four and a half *hours*, one way. The ground can navigate a probe beautifully — as long as nothing needs to be decided faster than light can carry the news home and a reply back out. For seventy years, almost nothing did. That is about to be the whole problem.
