#!/usr/bin/env node
// Fetch Wikimedia hero + 4-gallery images for the 2 follow-up entries
// (lc-34, mars2-orbiter). Mirrors scripts/fetch-tier-g-images.mjs.
...
const SPEC = JSON.parse(readFileSync('/tmp/followup-images.json', 'utf8'));
