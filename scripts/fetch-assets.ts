...
const FLEET_IMAGE_QUERIES: FleetImageQuery[] = [
  ...
  {
    id: 'f-1',
    query: 'F-1 rocket engine Saturn V',
    agency: 'NASA',
    extraQueries: ['Rocketdyne F-1 engine'],
  },
  {
    id: 'j-2',
    query: 'J-2 rocket engine Saturn',
    agency: 'NASA',
    extraQueries: ['Rocketdyne J-2 engine'],
  },
  {
    id: 'h-1',
    query: 'H-1 rocket engine Saturn IB',
    agency: 'NASA',
    extraQueries: ['Rocketdyne H-1 engine'],
  },
  {
    id: 'rs-25',
    query: 'RS-25 Space Shuttle Main Engine',
    agency: 'NASA',
    extraQueries: ['SSME engine test firing'],
  },
  {
    id: 'rl10',
    query: 'RL10 rocket engine Centaur',
    agency: 'NASA',
    extraQueries: ['RL10 engine'],
  },
  {
    id: 'rocketdyne-a7',
    query: 'Redstone rocket engine Rocketdyne A-7',
    agency: 'NASA',
    extraQueries: ['Mercury Redstone engine'],
  },
  {
    id: 'merlin-1d',
    query: 'SpaceX Merlin engine',
    agency: 'SPACEX',
    extraQueries: ['Merlin 1D engine Falcon 9'],
  },
  {
    id: 'raptor',
    query: 'SpaceX Raptor engine',
    agency: 'SPACEX',
    extraQueries: ['Raptor engine test firing'],
  },
  {
    id: 'rd-107-108',
    query: 'RD-107 rocket engine',
    agency: 'ROSCOSMOS',
    extraQueries: ['РД-107 двигатель', 'RD-108 engine', 'RD-107A Soyuz engine'],
  },
  {
    id: 'rd-180',
    query: 'RD-180 rocket engine',
    agency: 'ROSCOSMOS',
    extraQueries: ['РД-180 двигатель', 'RD-180 Atlas V engine'],
  },
  {
    id: 'rd-253',
    query: 'RD-253 rocket engine Proton',
    agency: 'ROSCOSMOS',
    extraQueries: ['РД-253 двигатель'],
  },
  {
    id: 'vulcain-2',
    query: 'Vulcain 2 rocket engine Ariane 5',
    agency: 'ESA',
    extraQueries: ['moteur Vulcain', 'Vulcain engine'],
  },
  {
    id: 'hm7b',
    query: 'HM7B rocket engine Ariane',
    agency: 'ESA',
    extraQueries: ['HM7 engine', 'moteur HM7B'],
  },
  {
    id: 'viking',
    query: 'Viking rocket engine Ariane',
    agency: 'ESA',
    extraQueries: ['moteur Viking Ariane'],
  },
  {
    id: 'yf-100',
