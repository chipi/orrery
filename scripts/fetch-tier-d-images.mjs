#!/usr/bin/env node
// Fetch Wikimedia images for Tier D (Lunar Orbiter 1-5). Same pattern as
// scripts/fetch-tier-{b,c}-images.mjs.
...
const SPEC = JSON.parse(readFileSync('/tmp/tier-d-images.json', 'utf8'));
