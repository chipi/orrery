#!/usr/bin/env node
// Fetch Wikimedia images for Tier G (Salyut 2-5). Sparser than Tier B/C/D —
// salyut-2 has only 2 verified files on Commons, others 5.
...
const SPEC = JSON.parse(readFileSync('/tmp/tier-g-images.json', 'utf8'));
