...
const MISSION_OVERLAYS = {
  rosetta: {
    ...
    'zh-CN': {
      ...
      description: 'ESA的旗舰彗星交会任务。经过包括三次地球引力辅助、一次火星辅助、两次小行星飞越和957天深空休眠的10年巡航后，罗塞塔号于2014年8月抵达丘留莫夫-格拉西缅科彗星（67P），并环绕它运行了两年多。菲莱着陆器于2014-11-12抵达67P表面 — 这是史上首次在彗星上软着陆。罗塞塔号于2016-09-30以受控下降至67P表面结束任务。',
    },
  },
  giotto: {
    ar: {
  ...
  'vega-1': {
    ar: {
      ...
      description: 'مهمة سوفيتية-أوروبية ضمن أسطول هالي. حملت فيغا 1 هابطة من سلالة فينيرا وبالون هيليوم بنته وكالة الفضاء الأوروبية/المركز الوطني الفرنسي للدراسات الفضائية، طاف على ارتفاع 54 كم في الغلاف الجوي للزهرة 46.5 ساعة. ثم استخدم الناقل مساعدة جاذبية الزهرة للتوجه إلى مذنب 1P/هالي، حيث حقق أقرب مرور (8890 كم) في 6 مارس 1986 — أول مواجهة لنواة مذنب على الإطلاق.',
    },
    de: {
      name: 'Vega 1',
      type: 'VORBEIFLUG + LANDER + BALLON · BEENDET',
      first: 'Erste Ballonsonde in der Atmosphäre eines anderen Planeten (Venus, 1985)',
      description: 'Sowjetisch-ESA-Mission der Halley-Armada. Vega 1 trug einen Venus-Lander der Venera-Linie und einen ESA/CNES-gebauten Heliumballon, der 46,5 Stunden lang in 54 km Höhe in der Venus-Atmosphäre trieb. Nach Abwurf der Landeeinheit nutzte der Bus eine Venus-Gravitationsassistenz, um zum Kometen 1P/Halley umzulenken, wo er am 6.3.1986 den nächsten Anflug (8890 km) absolvierte — die erste Beobachtung eines Kometenkerns überhaupt.',
    },
    es: {
      name: 'Vega 1',
    ...
    'pt-BR': {
      ...
      description: 'Missão soviético-ESA da armada de Halley. A Vega 1 carregou um aterrissador da linhagem Venera e um balão de hélio construído pela ESA/CNES que flutuou por 46,5 horas a 54 km de altitude na atmosfera venusiana. Após soltar o módulo de descida, o barramento usou assistência gravitacional venusiana para se redirecionar ao cometa 1P/Halley, onde conseguiu sua aproximação máxima (8890 km) em 6-3-1986 — o primeiro encontro com um núcleo cometário.',
    },
    ru: {
      name: 'Вега-1',
  ...
  'venera-13': {
    ar: {
      name: 'فينيرا 13',
      type: 'هابطة · مكتملة',
      first: 'أطول بقاء على سطح أي مهمة إلى الزهرة (127 دقيقة)؛ أول صور بانورامية ملونة وأول صوت من سطح كوكب آخر',
      description: 'ذروة برنامج فينيرا السوفيتي. هبطت فينيرا 13 في 1 مارس 1982 على 7.5°ج 303°ش في مرتفعات فيبي ريجيو. ظروف السطح عند الهبوط: 457 °م، 89 بار، ضباب حمض الكبريتيك. نجت الهابطة 127 دقيقة — تجاوزت هدف تصميمها بنحو ساعة — وأعادت أول بانوراميات ملونة من سطح كوكب آخر، وسجلت أول صوت بميكروفون الرياح، واستخدمت مثقابها لتحديد أن البازلت في موقع الهبوط كان تركيبة قلوية لوسيت متمايزة قليلاً.',
    },
    de: {
      name: 'Venera 13',
      type: 'LANDER · BEENDET',
      first: 'Längstes Überleben auf der Oberfläche aller Venus-Missionen (127 min); erste Farbpanoramen + erste Audiodaten von der Oberfläche eines anderen Planeten',
      description: 'Höhepunkt des sowjetischen Venera-Programms. Venera 13 landete am 1.3.1982 bei 7,5°S 303°E im Hochland Phoebe Regio. Oberflächenbedingungen bei Aufsetzen: 457 °C, 89 bar, Schwefelsäure-Smog. Der Lander überlebte 127 Minuten — fast eine Stunde über das Designziel hinaus — lieferte die ersten Farbpanoramen einer anderen Planetenoberfläche, nahm mit dem Windmikrofon Geräusche auf und stellte mit seinem Bohrer fest, dass der Basalt am Landeplatz eine schwach differenzierte leucit-alkalische Zusammensetzung aufwies.',
    },
    es: {
      name: 'Venera 13',
      type: 'ATERRIZADOR · FINALIZADA',
      first: 'Mayor supervivencia en superficie de cualquier misión a Venus (127 min); primeras panorámicas a color y primer audio de la superficie de otro planeta',
      description: 'Cumbre del programa Venera soviético. Venera 13 aterrizó el 1-3-1982 en 7,5°S 303°E en las tierras altas de Phoebe Regio. Condiciones superficiales al aterrizar: 457 °C, 89 bar, neblina de ácido sulfúrico. El aterrizador sobrevivió 127 minutos — superando su meta de diseño en casi una hora — devolvió las primeras panorámicas a color de la superficie de otro planeta, grabó el primer audio con micrófono de viento y usó su taladro para determinar que el basalto del lugar era una composición leucítica alcalina débilmente diferenciada.',
    },
    fr: {
      name: 'Venera 13',
      type: 'ATTERRISSEUR · TERMINÉE',
      first: 'Plus longue survie en surface de toute mission vers Vénus (127 min) ; premières panoramiques couleur et premier audio depuis la surface d\'une autre planète',
      description: 'Apogée du programme soviétique Venera. Venera 13 s\'est posée le 1/3/1982 à 7,5°S 303°E dans les hautes terres de Phoebe Regio. Conditions de surface à l\'atterrissage : 457 °C, 89 bars, brume d\'acide sulfurique. L\'atterrisseur a survécu 127 minutes — dépassant son objectif de conception de près d\'une heure — a retourné les premières panoramiques couleur de la surface d\'une autre planète, a enregistré le premier audio avec un microphone à vent et a utilisé sa foreuse pour déterminer que le basalte du site était une composition leucitique alcaline faiblement différenciée.',
    },
    hi: {
      name: 'वेनेरा 13',
      type: 'लैंडर · पूर्ण',
      first: 'किसी भी शुक्र मिशन की सबसे लंबी सतह उत्तरजीविता (127 मिनट); पहली रंगीन पैनोरामिक छवियां और किसी अन्य ग्रह की सतह से पहला ऑडियो',
      description: 'सोवियत वेनेरा कार्यक्रम का शिखर। वेनेरा 13 1-3-1982 को 7.5°दक्षिण 303°पूर्व फीबे रीजियो उच्चभूमि में उतरा। टचडाउन पर सतह की स्थिति: 457 °सेल्सियस, 89 बार, सल्फ्यूरिक एसिड धुंध। लैंडर 127 मिनट तक जीवित रहा — अपने डिजाइन लक्ष्य से लगभग एक घंटा अधिक — किसी अन्य ग्रह की सतह की पहली रंगीन पैनोरामिक छवियां लौटाईं, विंड माइक्रोफोन के साथ पहला ऑडियो रिकॉर्ड किया, और अपनी ड्रिल का उपयोग करके निर्धारित किया कि लैंडिंग साइट का बेसाल्ट कमजोर रूप से विभेदित ल्यूसाइट क्षारीय संरचना था।',
    },
    it: {
      name: 'Venera 13',
      type: 'LANDER · COMPLETATA',
      first: 'Più lunga sopravvivenza in superficie di qualsiasi missione su Venere (127 min); prime panoramiche a colori e primo audio dalla superficie di un altro pianeta',
      description: 'Apice del programma sovietico Venera. Venera 13 atterrò il 1/3/1982 a 7,5°S 303°E nelle terre alte di Phoebe Regio. Condizioni di superficie al touchdown: 457 °C, 89 bar, foschia di acido solforico. Il lander sopravvisse 127 minuti — superando il suo obiettivo di progetto di quasi un\'ora — restituendo le prime panoramiche a colori della superficie di un altro pianeta, registrando il primo audio con microfono per il vento e usando il suo trapano per determinare che il basalto del sito di atterraggio era una composizione leucitica alcalina debolmente differenziata.',
    },
    ja: {
      name: 'ベネラ13号',
      type: 'ランダー · 終了',
      first: '全金星ミッション中最長の表面生存（127分）；他惑星表面からの初のカラーパノラマと初の音声',
      description: 'ソビエト・ベネラ計画の頂点。ベネラ13号は1982年3月1日にフォエベ・レジオ高地の7.5°S 303°Eに着陸。着地時の表面条件：457 °C、89バール、硫酸スモッグ。ランダーは127分間生存 — 設計目標を約1時間超過 — 他惑星表面の初のカラーパノラマを返し、風マイクで初の音声を録音し、ドリルを使用して着陸地点の玄武岩が弱く分化したロイサイト・アルカリ組成であることを判定しました。',
    },
    ko: {
      name: '베네라 13호',
      type: '착륙선 · 완료',
      first: '모든 금성 임무 중 최장 표면 생존(127분); 다른 행성 표면의 첫 컬러 파노라마 영상 및 첫 음성',
      description: '소비에트 베네라 프로그램의 정점. 베네라 13호는 1982-3-1 피베 레지오 고지대의 7.5°S 303°E에 착륙. 착륙 시 표면 조건: 457°C, 89bar, 황산 안개. 착륙선은 127분 동안 생존 — 설계 목표를 거의 1시간 초과 — 다른 행성 표면의 첫 컬러 파노라마를 반환하고, 풍속 마이크로 첫 음성을 녹음하고, 드릴을 사용하여 착륙 지점의 현무암이 약하게 분화된 류사이트 알칼리 조성임을 결정했습니다.',
    },
    nl: {
      name: 'Venera 13',
      type: 'LANDER · VOLTOOID',
      first: 'Langste oppervlakteoverleving van enige Venusmissie (127 min); eerste kleurenpanorama\'s en eerste audio van het oppervlak van een andere planeet',
      description: 'Hoogtepunt van het Sovjet-Venera-programma. Venera 13 landde op 1-3-1982 op 7,5°Z 303°O in de hooglanden van Phoebe Regio. Oppervlakteomstandigheden bij landing: 457 °C, 89 bar, zwavelzuurnevel. De lander overleefde 127 minuten — bijna een uur boven zijn ontwerptarget — leverde de eerste kleurenpanorama\'s van een ander planeetoppervlak, nam met een windmicrofoon het eerste audio op en gebruikte zijn boor om vast te stellen dat het basalt van de landingsplaats een zwak gedifferentieerde leuciet-alkalische samenstelling had.',
    },
    'pt-BR': {
      name: 'Venera 13',
      type: 'ATERRISSADOR · CONCLUÍDA',
      first: 'Maior sobrevivência em superfície de qualquer missão a Vênus (127 min); primeiras imagens panorâmicas em cores e primeiro áudio da superfície de outro planeta',
      description: 'Auge do programa Venera soviético. A Venera 13 pousou em 1-3-1982 em 7,5°S 303°L nas terras altas de Phoebe Regio. Condições de superfície na aterrissagem: 457 °C, 89 bar, névoa de ácido sulfúrico. O aterrissador sobreviveu 127 minutos — superando sua meta de projeto em quase uma hora — devolveu os primeiros panoramas em cores da superfície de outro planeta, gravou o primeiro áudio com microfone de vento e usou sua broca para determinar que o basalto do local era uma composição leucítica alcalina fracamente diferenciada.',
    },
    ru: {
      name: 'Венера-13',
      type: 'СПУСКАЕМЫЙ · ЗАВЕРШЕНА',
      first: 'Самое длительное выживание на поверхности среди всех венерианских миссий (127 мин); первые цветные панорамы и первое аудио с поверхности другой планеты',
      description: 'Вершина советской программы «Венера». «Венера-13» приземлилась 1.3.1982 на 7,5°ю.ш. 303°в.д. в высокогорьях Феба-Регион. Условия на поверхности при посадке: 457 °C, 89 бар, серно-кислотный туман. Спускаемый аппарат выжил 127 минут — почти на час перевыполнив проектную цель — передал первые цветные панорамы поверхности другой планеты, записал первое аудио с микрофоном ветра и использовал бур для определения того, что базальт посадочной площадки имеет слабо дифференцированный лейцит-щелочной состав.',
    },
    'sr-Cyrl': {
      name: 'Венера 13',
      type: 'ЛЕНДЕР · ЗАВРШЕНА',
      first: 'Најдуже преживљавање на површини било које венеријанске мисије (127 мин); прве колор панораме и први звук са површине другог планета',
      description: 'Врхунац совјетског Венера програма. Венера 13 је слетела 1.3.1982. на 7,5°Ј 303°И у висоравни Фебе Регио. Услови површине при слетању: 457 °C, 89 бара, магла сумпорне киселине. Лендер је преживео 127 минута — премашујући свој дизајнерски циљ за скоро сат — вратио је прве колор панораме површине другог планета, снимио први звук са микрофоном за ветар и користио бушилицу да утврди да је базалт на месту слетања слабо диференцирана леуцит-алкална композиција.',
    },
    'zh-CN': {
      name: '金星13号',
      type: '着陆器 · 已完成',
      first: '所有金星任务中最长的表面生存时间（127分钟）；其他行星表面首次彩色全景图像和首次音频',
      description: '苏联金星计划的巅峰。金星13号于1982-3-1降落在菲比区高地7.5°南303°东。着陆时表面条件：457°C，89巴，硫酸雾。着陆器存活了127分钟 — 比设计目标超出近一小时 — 返回了其他行星表面的首批彩色全景图像，使用风麦克风记录了第一段音频，并使用钻头确定着陆点的玄武岩是弱分化的白榴石碱性组成。',
    },
  },
  hayabusa2: {
    ar: {
      ...
      first: 'ثاني إعادة عينات من كويكب (ريوغو، 2020)؛ أول حفرة اصطدامية اصطناعية على كويكب؛ أول مواد كويكبية تحت سطحية أُعيدت إلى الأرض',
      description: 'تابع جاكسا لهايابوسا الأصلية. أُطلقت في 3 ديسمبر 2014، ووصلت هايابوسا 2 إلى الكويكب القريب من الأرض (162173) ريوغو في 27 يونيو 2018. عمليات السطح 2018-2019 أعادت أول مسح قريب مستدام لكويكب من نوع C ركام-حُطام. هبطت كبسولة إعادة العينات فوق وومرا، أستراليا في 5 ديسمبر 2020 وسلمت 5.4 جم من مواد ريوغو النقية — أول عينة كويكب ذات طبقات تحت سطحية. مهمة موسعة: تحليق فوق (98943) 2001 CC21 في يوليو 2026؛ التقاء مع (1998 KY26) سريع الدوران مستهدف لـ يوليو 2031.',
    },
    de: {
      name: 'Hayabusa2',
      type: 'PROBENRÜCKKEHR + LANDER · AKTIV (verlängert)',
      first: 'Zweite Asteroiden-Probenrückkehr (Ryugu, 2020); erster künstlicher Einschlagkrater auf einem Asteroiden; erste tieferliegende Asteroidenproben zur Erde gebracht',
      description: 'JAXAs Nachfolger der ursprünglichen Hayabusa. Gestartet am 3.12.2014, erreichte Hayabusa2 den erdnahen Asteroiden (162173) Ryugu am 27.6.2018. Oberflächenoperationen 2018-2019 lieferten die erste anhaltende Nahaufnahme eines Schutthaufen-C-Typ-Asteroiden. Die Probenrückkehrkapsel landete am 5.12.2020 über Woomera, Australien, und lieferte 5,4 g unberührtes Ryugu-Material — die erste Asteroidenprobe mit unterirdischer Stratigrafie. Erweiterte Mission: Vorbeiflug an (98943) 2001 CC21 im Juli 2026; Rendezvous mit dem schnell rotierenden (1998 KY26) für Juli 2031 anvisiert.',
    },
    es: {
      name: 'Hayabusa2',
      type: 'RETORNO DE MUESTRAS + ATERRIZADORES · ACTIVA (ampliada)',
      first: 'Segundo retorno de muestras de asteroide (Ryugu, 2020); primer cráter artificial en un asteroide; primer material subsuperficial de asteroide devuelto a la Tierra',
      description: 'Continuación de JAXA de la Hayabusa original. Lanzada el 3-12-2014, Hayabusa2 alcanzó el asteroide cercano a la Tierra (162173) Ryugu el 27-6-2018. Operaciones de superficie 2018-2019 devolvieron el primer estudio cercano sostenido de un asteroide de tipo C en pila de escombros. La cápsula de retorno de muestras aterrizó sobre Woomera, Australia el 5-12-2020 entregando 5,4 g de material prístino de Ryugu — la primera muestra de asteroide con estratigrafía subsuperficial. Misión ampliada: sobrevuelo de (98943) 2001 CC21 en julio de 2026; encuentro con el (1998 KY26) de rotación rápida apuntado para julio de 2031.',
    },
    fr: {
      name: 'Hayabusa2',
      type: 'RETOUR D\'ÉCHANTILLONS + ATTERRISSEURS · ACTIVE (étendue)',
      first: 'Deuxième retour d\'échantillons d\'astéroïde (Ryugu, 2020) ; premier cratère artificiel sur un astéroïde ; premier matériau sous-surface d\'astéroïde rapporté sur Terre',
      description: 'Suite par la JAXA de l\'Hayabusa originale. Lancée le 3/12/2014, Hayabusa2 a atteint l\'astéroïde géocroiseur (162173) Ryugu le 27/6/2018. Les opérations de surface 2018-2019 ont produit la première étude rapprochée soutenue d\'un astéroïde de type C en tas de gravats. La capsule de retour d\'échantillons a atterri au-dessus de Woomera, Australie le 5/12/2020 livrant 5,4 g de matériau intact de Ryugu — le premier échantillon d\'astéroïde avec stratigraphie sous-surface. Mission étendue : survol de (98943) 2001 CC21 en juillet 2026 ; rendez-vous avec le rapide (1998 KY26) visé pour juillet 2031.',
    },
    hi: {
      name: 'हायाबुसा 2',
      type: 'नमूना वापसी + लैंडर · सक्रिय (विस्तारित)',
      first: 'दूसरा क्षुद्रग्रह नमूना वापसी (रयूगु, 2020); किसी क्षुद्रग्रह पर पहला कृत्रिम प्रभाव गड्ढा; पृथ्वी पर वापस लाया गया पहला उपसतह क्षुद्रग्रह पदार्थ',
      description: 'जाक्सा द्वारा मूल हायाबुसा का अनुसरण। 3-12-2014 को लॉन्च, हायाबुसा 2 27-6-2018 को निकट-पृथ्वी क्षुद्रग्रह (162173) रयूगु पर पहुंचा। सतह संचालन 2018-2019 ने मलबे-ढेर सी-प्रकार क्षुद्रग्रह का पहला निरंतर निकट सर्वेक्षण लौटाया। नमूना वापसी कैप्सूल 5-12-2020 को वूमेरा, ऑस्ट्रेलिया पर उतरा और रयूगु की 5.4 ग्राम मूल सामग्री दी — उपसतह स्ट्रैटिग्राफी वाला पहला क्षुद्रग्रह नमूना। विस्तारित मिशन: जुलाई 2026 में (98943) 2001 CC21 का फ्लाईबाई; जुलाई 2031 के लिए तेजी से घूमने वाले (1998 KY26) से मिलन निशाना।',
    },
    it: {
      name: 'Hayabusa2',
      type: 'RIENTRO CAMPIONI + LANDER · ATTIVA (estesa)',
      first: 'Secondo rientro di campioni di asteroide (Ryugu, 2020); primo cratere artificiale su un asteroide; primo materiale sub-superficiale di asteroide riportato sulla Terra',
      description: 'Seguito di JAXA all\'Hayabusa originale. Lanciata il 3/12/2014, Hayabusa2 ha raggiunto l\'asteroide vicino alla Terra (162173) Ryugu il 27/6/2018. Le operazioni di superficie 2018-2019 hanno restituito il primo sondaggio ravvicinato sostenuto di un asteroide di tipo C a cumulo di macerie. La capsula di rientro campioni è atterrata sopra Woomera, Australia il 5/12/2020 consegnando 5,4 g di materiale incontaminato di Ryugu — il primo campione di asteroide con stratigrafia sub-superficiale. Missione estesa: sorvolo di (98943) 2001 CC21 nel luglio 2026; rendezvous con il rapido (1998 KY26) mirato per luglio 2031.',
    },
    ja: {
      name: 'はやぶさ2',
      type: 'サンプルリターン + ランダー · 運用中（延長）',
      first: '2回目の小惑星サンプルリターン（リュウグウ、2020年）；小惑星初の人工衝突クレーター；地球に戻された初の小惑星地下物質',
      description: 'JAXAのオリジナルはやぶさの後継機。2014年12月3日に打ち上げられたはやぶさ2は2018年6月27日に地球近傍小惑星（162173）リュウグウに到達。2018-2019年の表面運用は、瓦礫山C型小惑星の初の継続的接写調査を返しました。サンプルリターンカプセルは2020年12月5日にオーストラリアのウーメラ上空で着陸、リュウグウの純粋な物質5.4 gを届けました — 地下層序を持つ初の小惑星サンプル。延長ミッション：2026年7月に（98943）2001 CC21の通過；2031年7月に急速回転する（1998 KY26）との接近を予定。',
    },
    ko: {
      name: '하야부사2호',
      type: '샘플 귀환 + 착륙선 · 활성(연장)',
      first: '두 번째 소행성 샘플 귀환(류구, 2020); 소행성 최초의 인공 충돌 분화구; 지구로 가져온 최초의 지하 소행성 물질',
      description: 'JAXA의 원조 하야부사 후속. 2014-12-3 발사된 하야부사2호는 2018-6-27 지구근접 소행성 (162173) 류구에 도달. 2018-2019 표면 운영은 잔해 더미 C형 소행성의 첫 지속적 근접 조사를 반환했습니다. 샘플 귀환 캡슐은 2020-12-5 호주 우메라 상공에 착륙하여 류구의 순수 물질 5.4g을 전달 — 지하 층서를 가진 최초의 소행성 샘플. 연장 임무: 2026년 7월 (98943) 2001 CC21 플라이바이; 2031년 7월 빠르게 회전하는 (1998 KY26)과의 랑데부 목표.',
    },
    nl: {
      name: 'Hayabusa2',
      type: 'MONSTERS RETOUR + LANDERS · ACTIEF (verlengd)',
      first: 'Tweede asteroïde-monsterretour (Ryugu, 2020); eerste kunstmatige inslagkrater op een asteroïde; eerste ondergrondse asteroïdemateriaal teruggebracht naar de Aarde',
      description: 'JAXA\'s vervolg op de oorspronkelijke Hayabusa. Gelanceerd op 3-12-2014, bereikte Hayabusa2 de aardscheerder (162173) Ryugu op 27-6-2018. Oppervlakteoperaties 2018-2019 leverden de eerste aanhoudende close-upsurvey van een puinhoop C-type asteroïde op. De monsterretourcapsule landde op 5-12-2020 boven Woomera, Australië en leverde 5,4 g maagdelijk Ryugu-materiaal — het eerste asteroïdemonster met ondergrondse stratigrafie. Verlengde missie: scheervlucht van (98943) 2001 CC21 in juli 2026; rendezvous met de snel roterende (1998 KY26) gericht voor juli 2031.',
    },
    'pt-BR': {
      name: 'Hayabusa2',
      type: 'RETORNO DE AMOSTRAS + ATERRISSADORES · ATIVA (estendida)',
      first: 'Segundo retorno de amostras de asteroide (Ryugu, 2020); primeira cratera de impacto artificial em um asteroide; primeiro material subsuperficial de asteroide trazido de volta à Terra',
      description: 'Continuação da JAXA da Hayabusa original. Lançada em 3-12-2014, a Hayabusa2 alcançou o asteroide próximo da Terra (162173) Ryugu em 27-6-2018. As operações de superfície 2018-2019 retornaram o primeiro levantamento próximo sustentado de um asteroide de pilha de escombros tipo C. A cápsula de retorno de amostras pousou sobre Woomera, Austrália em 5-12-2020 entregando 5,4 g de material prístino de Ryugu — a primeira amostra de asteroide com estratigrafia subsuperficial. Missão estendida: sobrevoo de (98943) 2001 CC21 em julho de 2026; encontro com o rapidamente rotativo (1998 KY26) visado para julho de 2031.',
    },
    ru: {
      name: 'Хаябуса-2',
      type: 'ВОЗВРАТ ОБРАЗЦОВ + СПУСКАЕМЫЕ · АКТИВНА (продлена)',
      first: 'Второй возврат образцов с астероида (Рюгу, 2020); первый искусственный ударный кратер на астероиде; первый подповерхностный материал астероида, возвращённый на Землю',
      description: 'Продолжение JAXA оригинальной «Хаябусы». Запущена 3.12.2014, «Хаябуса-2» достигла околоземного астероида (162173) Рюгу 27.6.2018. Поверхностные операции 2018-2019 годов позволили провести первое продолжительное близкое исследование астероида C-типа из груды обломков. Капсула возврата образцов приземлилась над Вумерой, Австралия 5.12.2020, доставив 5,4 г нетронутого материала Рюгу — первый образец астероида с подповерхностной стратиграфией. Расширенная миссия: пролёт (98943) 2001 CC21 в июле 2026 г.; сближение с быстро вращающимся (1998 KY26) намечено на июль 2031 г.',
    },
    'sr-Cyrl': {
      name: 'Хајабуса 2',
      type: 'ПОВРАТАК УЗОРАКА + ЛЕНДЕРИ · АКТИВНА (продужена)',
      first: 'Други повратак узорака астероида (Рјугу, 2020.); први вештачки кратер удара на астероиду; први подповршински астероидни материјал враћен на Земљу',
      description: 'ЈАКСА-ин наставак оригиналне Хајабусе. Лансирана 3.12.2014, Хајабуса 2 је достигла блискоземаљски астероид (162173) Рјугу 27.6.2018. Операције на површини 2018-2019 вратиле су прво континуирано блиско истраживање астероида типа Ц у гомили крхотина. Капсула за повратак узорака слетела је изнад Вумере, Аустралија 5.12.2020. испоручујући 5,4 г нетакнутог Рјугу материјала — први астероидни узорак са подповршинском стратиграфијом. Продужена мисија: прелет (98943) 2001 CC21 у јулу 2026; сусрет са брзо ротирајућим (1998 KY26) циљан за јул 2031.',
    },
    'zh-CN': {
      name: '隼鸟2号',
      type: '样本返回 + 着陆器 · 活跃（延长）',
      first: '第二次小行星样本返回（龙宫，2020）；小行星上首次人造撞击坑；首次将地下小行星物质带回地球',
      description: 'JAXA对原始隼鸟号的后续任务。2014-12-3发射，隼鸟2号于2018-6-27抵达近地小行星（162173）龙宫。2018-2019年的表面操作返回了对碎石堆C型小行星的首次持续近距离勘测。样本返回舱于2020-12-5降落在澳大利亚伍默拉上空，交付5.4克原始龙宫物质 — 首个具有地下层位的小行星样本。延长任务：2026年7月飞掠（98943）2001 CC21；2031年7月与快速旋转的（1998 KY26）会合。',
    },
  },
  juice: {
    ar: {
      name: 'جوس',
      type: 'مدارية · نشطة',
      first: 'أكبر مركبة فضائية كوكبية صنعتها أوروبا؛ أول مركبة على الإطلاق تدور حول قمر كوكب آخر (غانيميد، 2034)',
      description: 'مستكشف أقمار المشتري الجليدية — مهمة وكالة الفضاء الأوروبية الرائدة من الفئة L، أُطلقت في 14 أبريل 2023. تستخدم رحلة الـ 8 سنوات أحد أكثر تسلسلات المساعدة الجاذبية تعقيداً التي طُيرت على الإطلاق: مساعدة جاذبية قمرية-أرضية ذات أول نوع في 19 أغسطس 2024، الزهرة في 31 أغسطس 2025، ثم مرور أرضي إضافي في 2026 و 2029. إدخال مدار المشتري مقرر في 21 يوليو 2031. بعد 35 مروراً قريباً بأوروبا وغانيميد وكاليستو على مدى 3.5 سنوات، ستناور جوس إلى مدار غانيميد مخصص في 31 ديسمبر 2034 — أول مركبة فضائية تدور حول قمر كوكب آخر.',
    },
    de: {
      name: 'JUICE',
      type: 'ORBITER · AKTIV',
      first: 'Größte je in Europa gebaute interplanetare Raumsonde; erstes Raumfahrzeug, das einen Mond eines anderen Planeten umkreist (Ganymed, 2034)',
      description: 'JUpiter ICy moons Explorer — ESAs L-Klasse-Flaggschiff, gestartet am 14.4.2023. Die 8-jährige Reise nutzt eine der komplexesten Gravitationsassistenz-Sequenzen, die je geflogen wurden: eine erstmalige Mond-Erde-Gravitationsassistenz am 19.8.2024, Venus am 31.8.2025, dann zwei weitere Erdbahn-Vorbeiflüge 2026 und 2029. Jupiter-Orbit-Einschuss ist für den 21.7.2031 angesetzt. Nach 35 engen Vorbeiflügen an Europa, Ganymed und Kallisto über 3,5 Jahre wird JUICE am 31.12.2034 in einen dedizierten Ganymed-Orbit manövriert — das erste Raumfahrzeug überhaupt, das einen Mond eines anderen Planeten umkreist.',
    },
    es: {
      name: 'JUICE',
      type: 'ORBITADOR · ACTIVA',
      first: 'Nave interplanetaria más grande construida en Europa; primera nave en orbitar una luna de otro planeta (Ganímedes, 2034)',
      description: 'JUpiter ICy moons Explorer — misión insignia de clase L de la ESA, lanzada el 14-4-2023. El crucero de 8 años usa una de las secuencias de asistencia gravitatoria más complejas jamás voladas: una asistencia gravitatoria Luna-Tierra inédita el 19-8-2024, Venus el 31-8-2025, luego dos pasos terrestres más en 2026 y 2029. La inserción en órbita joviana está fijada para el 21-7-2031. Tras 35 sobrevuelos cercanos de Europa, Ganímedes y Calisto a lo largo de 3,5 años, JUICE maniobrará a una órbita dedicada de Ganímedes el 31-12-2034 — la primera nave que orbita una luna de otro planeta.',
    },
    fr: {
      name: 'JUICE',
      type: 'ORBITEUR · ACTIVE',
      first: 'Plus grand vaisseau interplanétaire construit en Europe ; premier vaisseau à orbiter une lune d\'une autre planète (Ganymède, 2034)',
      description: 'JUpiter ICy moons Explorer — mission phare de classe L de l\'ESA, lancée le 14/4/2023. La croisière de 8 ans utilise l\'une des séquences d\'assistance gravitationnelle les plus complexes jamais volées : une assistance gravitationnelle Lune-Terre inédite le 19/8/2024, Vénus le 31/8/2025, puis deux passages terrestres supplémentaires en 2026 et 2029. L\'insertion en orbite jovienne est prévue pour le 21/7/2031. Après 35 survols rapprochés d\'Europe, Ganymède et Callisto sur 3,5 ans, JUICE manœuvrera vers une orbite dédiée de Ganymède le 31/12/2034 — le premier vaisseau à orbiter une lune d\'une autre planète.',
    },
    hi: {
      name: 'JUICE',
      type: 'ऑर्बिटर · सक्रिय',
      first: 'यूरोप में निर्मित सबसे बड़ा अंतरग्रहीय अंतरिक्षयान; किसी अन्य ग्रह के चंद्रमा की परिक्रमा करने वाला पहला अंतरिक्षयान (गेनिमीड, 2034)',
      description: 'JUpiter ICy moons Explorer — ईएसए का एल-क्लास प्रमुख मिशन, 14-4-2023 को लॉन्च। 8-वर्षीय क्रूज अब तक उड़ाए गए सबसे जटिल गुरुत्व सहायता अनुक्रमों में से एक का उपयोग करता है: 19-8-2024 को पहली बार चंद्र-पृथ्वी गुरुत्व सहायता, 31-8-2025 को शुक्र, फिर 2026 और 2029 में दो और पृथ्वी मार्ग। बृहस्पति कक्षा प्रवेश 21-7-2031 के लिए निर्धारित है। 3.5 वर्षों में यूरोपा, गेनिमीड और कैलिस्टो के 35 निकट उड़ान-गुजर के बाद, JUICE 31-12-2034 को एक समर्पित गेनिमीड कक्षा में पैंतरेबाजी करेगा — किसी अन्य ग्रह के चंद्रमा की परिक्रमा करने वाला पहला अंतरिक्षयान।',
    },
    it: {
      name: 'JUICE',
      type: 'ORBITER · ATTIVA',
      first: 'Più grande veicolo interplanetario mai costruito in Europa; primo veicolo a orbitare una luna di un altro pianeta (Ganimede, 2034)',
      description: 'JUpiter ICy moons Explorer — missione di punta di classe L dell\'ESA, lanciata il 14/4/2023. La crociera di 8 anni usa una delle sequenze di assistenza gravitazionale più complesse mai volate: un\'assistenza gravitazionale Luna-Terra inedita il 19/8/2024, Venere il 31/8/2025, poi altri due passaggi terrestri nel 2026 e 2029. L\'inserimento in orbita gioviana è fissato per il 21/7/2031. Dopo 35 sorvoli ravvicinati di Europa, Ganimede e Callisto in 3,5 anni, JUICE manovrerà in un\'orbita dedicata di Ganimede il 31/12/2034 — il primo veicolo a orbitare una luna di un altro pianeta.',
    },
    ja: {
      name: 'JUICE',
      type: 'オービター · 運用中',
      first: '欧州で建造された最大の惑星間宇宙船；他惑星の衛星を周回する史上初の宇宙船（ガニメデ、2034年）',
      description: 'JUpiter ICy moons Explorer — ESAの旗艦Lクラスミッション、2023年4月14日打ち上げ。8年間の航行は飛行された中で最も複雑な重力アシスト・シーケンスの1つを使用：2024年8月19日の史上初の月-地球重力アシスト、2025年8月31日の金星、その後2026年と2029年にさらに2回の地球通過。木星軌道投入は2031年7月21日に設定。3.5年にわたる35回のエウロパ、ガニメデ、カリストの近接フライバイ後、JUICEは2034年12月31日に専用のガニメデ軌道へ機動 — 他惑星の衛星を周回する史上初の宇宙船。',
    },
    ko: {
      name: 'JUICE',
      type: '궤도선 · 활성',
      first: '유럽에서 만든 가장 큰 행성간 우주선; 다른 행성의 위성을 공전하는 사상 최초의 우주선(가니메데, 2034)',
      description: 'JUpiter ICy moons Explorer — ESA의 L급 기함 임무, 2023-4-14 발사. 8년간의 항해는 비행된 가장 복잡한 중력 도움 시퀀스 중 하나를 사용: 2024-8-19 사상 최초의 달-지구 중력 도움, 2025-8-31 금성, 그 후 2026년과 2029년에 두 번의 지구 통과. 목성 궤도 진입은 2031-7-21로 예정. 3.5년에 걸친 35회의 유로파, 가니메데, 칼리스토 근접 비행 후, JUICE는 2034-12-31 전용 가니메데 궤도로 기동 — 다른 행성의 위성을 공전하는 사상 최초의 우주선.',
    },
    nl: {
      name: 'JUICE',
      type: 'ORBITER · ACTIEF',
      first: 'Grootste interplanetaire ruimtevaartuig ooit in Europa gebouwd; eerste ruimtevaartuig dat een maan van een andere planeet omcirkelt (Ganymedes, 2034)',
      description: 'JUpiter ICy moons Explorer — ESA\'s L-klasse vlaggenschipmissie, gelanceerd op 14-4-2023. De 8-jarige reis gebruikt een van de meest complexe zwaartekrachtassistentiesequenties ooit gevlogen: een primeur Maan-Aarde-zwaartekrachtassistentie op 19-8-2024, Venus op 31-8-2025, daarna nog twee Aardpassages in 2026 en 2029. Jupiter-baaninsertie is gepland voor 21-7-2031. Na 35 nauwe scheervluchten van Europa, Ganymedes en Callisto over 3,5 jaar zal JUICE op 31-12-2034 naar een speciale Ganymedes-baan manoeuvreren — het eerste ruimtevaartuig ooit dat een maan van een andere planeet omcirkelt.',
    },
    'pt-BR': {
      name: 'JUICE',
      type: 'ORBITADOR · ATIVA',
      first: 'Maior espaçonave interplanetária já construída na Europa; primeira espaçonave a orbitar uma lua de outro planeta (Ganimedes, 2034)',
      description: 'JUpiter ICy moons Explorer — missão carro-chefe classe L da ESA, lançada em 14-4-2023. O cruzeiro de 8 anos usa uma das sequências de assistência gravitacional mais complexas já voadas: uma assistência gravitacional Lua-Terra inédita em 19-8-2024, Vênus em 31-8-2025, depois mais duas passagens terrestres em 2026 e 2029. A inserção em órbita joviana está marcada para 21-7-2031. Após 35 sobrevoos próximos de Europa, Ganimedes e Calisto ao longo de 3,5 anos, a JUICE manobrará para uma órbita dedicada de Ganimedes em 31-12-2034 — a primeira espaçonave a orbitar uma lua de outro planeta.',
    },
    ru: {
      name: 'JUICE',
      type: 'ОРБИТАЛЬНЫЙ · АКТИВНА',
      first: 'Крупнейший межпланетный аппарат, построенный в Европе; первый аппарат, вышедший на орбиту спутника другой планеты (Ганимед, 2034)',
      description: 'JUpiter ICy moons Explorer — флагманская миссия класса L ЕКА, запущена 14.4.2023. 8-летний перелёт использует одну из самых сложных последовательностей гравитационных манёвров, когда-либо выполненных: первая в истории лунно-земная гравитационная асистенция 19.8.2024, Венера 31.8.2025, затем ещё два прохода у Земли в 2026 и 2029. Вывод на орбиту Юпитера запланирован на 21.7.2031. После 35 близких пролётов Европы, Ганимеда и Каллисто на протяжении 3,5 лет JUICE манёврирует на выделенную орбиту Ганимеда 31.12.2034 — первый аппарат, выведенный на орбиту спутника другой планеты.',
    },
    'sr-Cyrl': {
      name: 'JUICE',
      type: 'ОРБИТЕР · АКТИВНА',
      first: 'Највећа интерпланетарна летелица икада изграђена у Европи; прва летелица икада која ће орбитирати око месеца другог планета (Ганимед, 2034.)',
      description: 'JUpiter ICy moons Explorer — ЕСА-ина водећа L-класа мисија, лансирана 14.4.2023. Осмогодишњи пут користи једну од најкомплекснијих секвенци гравитационе асистенције икада изведену: прва Месечева-Земаљска гравитациона асистенција 19.8.2024, Венера 31.8.2025, па још два земаљска проласка 2026. и 2029. Улазак у Јупитерову орбиту заказан за 21.7.2031. После 35 блиских прелета Европе, Ганимеда и Калиста током 3,5 година, JUICE ће манипулисати у наменску орбиту Ганимеда 31.12.2034 — прва летелица икада која ће орбитирати око месеца другог планета.',
    },
    'zh-CN': {
      name: 'JUICE',
      type: '轨道器 · 活跃',
      first: '欧洲建造的最大行星际航天器；史上首个进入其他行星卫星轨道的航天器（木卫三，2034）',
      description: 'JUpiter ICy moons Explorer — ESA的L级旗舰任务，2023-4-14发射。8年的巡航使用了有史以来飞行过的最复杂引力辅助序列之一：2024-8-19史上首次月球-地球引力辅助，2025-8-31金星，然后2026年和2029年再两次地球通过。木星轨道进入定于2031-7-21。在3.5年内对木卫二、木卫三和木卫四进行35次近距离飞掠后，JUICE将于2034-12-31机动进入专用木卫三轨道 — 史上首个进入其他行星卫星轨道的航天器。',
    },
  },
  bepicolombo: {
    ar: {
      name: 'بيبي كولومبو',
      type: 'مدارية · نشطة',
      first: 'أول مهمة كوكبية مشتركة بين أوروبا واليابان؛ ثاني مركبة فضائية على الإطلاق تدور حول عطارد (بعد ميسنجر)',
      description: 'مهمة وكالة الفضاء الأوروبية / جاكسا المشتركة إلى عطارد، أُطلقت في 20 أكتوبر 2018 — سُميت على اسم الرياضي الإيطالي جوزيبي (بيبي) كولومبو، الذي صمم مسار الرحلات المتعددة لماريان 10. تستخدم رحلة الـ 8 سنوات 9 مساعدات جاذبية (الأرض 2020، الزهرة 2020، الزهرة 2021، ثم ستة مرورات بعطارد 2021-2024) بالإضافة إلى دفع كهربائي أيوني مستمر. إدخال مدار عطارد في 5 ديسمبر 2026؛ تبدأ العمليات العلمية أوائل 2027.',
    },
    de: {
      name: 'BepiColombo',
      type: 'ORBITER · AKTIV',
      first: 'Erste gemeinsame planetare Mission von Europa und Japan; zweites Raumfahrzeug überhaupt, das Merkur umkreist (nach Messenger)',
      description: 'Gemeinsame ESA-/JAXA-Mission zu Merkur, gestartet am 20.10.2018 — benannt nach dem italienischen Mathematiker Giuseppe (Bepi) Colombo, der die Mehrfach-Vorbeiflug-Trajektorie von Mariner 10 entwarf. Die 8-jährige Reise nutzt 9 Gravitationsassistenzen (Erde 2020, Venus 2020, Venus 2021, dann sechs Merkur-Vorbeiflüge 2021-2024) plus durchgehenden Ionenantrieb. Merkur-Orbit-Einschuss am 5.12.2026; wissenschaftliche Operationen beginnen Anfang 2027.',
    },
    es: {
      name: 'BepiColombo',
      type: 'ORBITADOR · ACTIVA',
      first: 'Primera misión planetaria conjunta Europa-Japón; segunda nave en orbitar Mercurio (tras Messenger)',
      description: 'Misión conjunta ESA / JAXA a Mercurio, lanzada el 20-10-2018 — nombrada por el matemático italiano Giuseppe (Bepi) Colombo, que diseñó la trayectoria de múltiples sobrevuelos de Mariner 10. El crucero de 8 años usa 9 asistencias gravitatorias (Tierra 2020, Venus 2020, Venus 2021, luego seis sobrevuelos de Mercurio 2021-2024) más empuje iónico-eléctrico continuo. Inserción en órbita de Mercurio el 5-12-2026; las operaciones científicas comienzan a principios de 2027.',
    },
    fr: {
      name: 'BepiColombo',
      type: 'ORBITEUR · ACTIVE',
      first: 'Première mission planétaire conjointe Europe-Japon ; deuxième vaisseau à orbiter Mercure (après Messenger)',
      description: 'Mission conjointe ESA / JAXA vers Mercure, lancée le 20/10/2018 — nommée d\'après le mathématicien italien Giuseppe (Bepi) Colombo, qui a conçu la trajectoire à survols multiples de Mariner 10. La croisière de 8 ans utilise 9 assistances gravitationnelles (Terre 2020, Vénus 2020, Vénus 2021, puis six survols de Mercure 2021-2024) plus une poussée ionique-électrique continue. Insertion en orbite mercurienne le 5/12/2026 ; les opérations scientifiques commencent début 2027.',
    },
    hi: {
      name: 'बेपीकोलंबो',
      type: 'ऑर्बिटर · सक्रिय',
      first: 'पहला यूरोप-जापान संयुक्त ग्रहीय मिशन; मरकरी की परिक्रमा करने वाला दूसरा अंतरिक्षयान (मेसेंजर के बाद)',
      description: 'ईएसए / जाक्सा का मरकरी का संयुक्त मिशन, 20-10-2018 को लॉन्च — इतालवी गणितज्ञ ज्यूसेप्पे (बेपी) कोलंबो के नाम पर, जिन्होंने मेरिनर 10 की मल्टी-फ्लाईबाई प्रक्षेपपथ डिजाइन की। 8-वर्षीय क्रूज 9 गुरुत्व सहायताओं (पृथ्वी 2020, शुक्र 2020, शुक्र 2021, फिर 2021-2024 में छह मरकरी फ्लाईबाई) के साथ-साथ निरंतर आयन-विद्युत प्रणोदन का उपयोग करता है। मरकरी कक्षा प्रवेश 5-12-2026; विज्ञान संचालन 2027 की शुरुआत में शुरू।',
    },
    it: {
      name: 'BepiColombo',
      type: 'ORBITER · ATTIVA',
      first: 'Prima missione planetaria congiunta Europa-Giappone; secondo veicolo a orbitare Mercurio (dopo Messenger)',
      description: 'Missione congiunta ESA / JAXA su Mercurio, lanciata il 20/10/2018 — chiamata in onore del matematico italiano Giuseppe (Bepi) Colombo, che progettò la traiettoria multi-sorvolo di Mariner 10. La crociera di 8 anni usa 9 assistenze gravitazionali (Terra 2020, Venere 2020, Venere 2021, poi sei sorvoli di Mercurio 2021-2024) più spinta ionica-elettrica continua. Inserimento in orbita mercuriana il 5/12/2026; le operazioni scientifiche iniziano a inizio 2027.',
    },
    ja: {
      name: 'ベピコロンボ',
      type: 'オービター · 運用中',
      first: '初の欧州・日本共同惑星ミッション；水星を周回する史上2番目の宇宙船（メッセンジャーに次ぐ）',
      description: '水星へのESA / JAXA共同ミッション、2018年10月20日打ち上げ — マリナー10号のマルチフライバイ軌道を設計したイタリアの数学者ジュゼッペ（ベピ）コロンボにちなんで命名。8年間の航行は9回の重力アシスト（地球2020、金星2020、金星2021、その後2021-2024年に6回の水星フライバイ）と連続イオン電気推進を使用。水星軌道投入は2026年12月5日；科学運用は2027年初頭に開始。',
    },
    ko: {
      name: '베피콜롬보',
      type: '궤도선 · 활성',
      first: '최초의 유럽-일본 공동 행성 임무; 수성을 공전하는 사상 두 번째 우주선(메신저 다음)',
      description: '수성으로의 ESA / JAXA 공동 임무, 2018-10-20 발사 — 매리너 10호의 다중 플라이바이 궤적을 설계한 이탈리아 수학자 주세페(베피) 콜롬보의 이름을 따서 명명. 8년간의 항해는 9회의 중력 도움(지구 2020, 금성 2020, 금성 2021, 그 후 2021-2024년 6회의 수성 플라이바이)과 연속 이온-전기 추진을 사용. 수성 궤도 진입은 2026-12-5; 과학 운영은 2027년 초에 시작.',
    },
    nl: {
      name: 'BepiColombo',
      type: 'ORBITER · ACTIEF',
      first: 'Eerste planetaire missie van Europa en Japan samen; tweede ruimtevaartuig ooit dat Mercurius omcirkelt (na Messenger)',
      description: 'Gezamenlijke ESA-/JAXA-missie naar Mercurius, gelanceerd op 20-10-2018 — vernoemd naar de Italiaanse wiskundige Giuseppe (Bepi) Colombo, die het traject met meerdere scheervluchten van Mariner 10 ontwierp. De 8-jarige reis gebruikt 9 zwaartekrachtassistenties (Aarde 2020, Venus 2020, Venus 2021, daarna zes Mercurius-scheervluchten 2021-2024) plus continue ionisch-elektrische stuwkracht. Mercurius-baaninsertie op 5-12-2026; wetenschappelijke operaties beginnen begin 2027.',
    },
    'pt-BR': {
      name: 'BepiColombo',
      type: 'ORBITADOR · ATIVA',
      first: 'Primeira missão planetária conjunta Europa-Japão; segunda espaçonave a orbitar Mercúrio (após Messenger)',
      description: 'Missão conjunta ESA / JAXA a Mercúrio, lançada em 20-10-2018 — nomeada em homenagem ao matemático italiano Giuseppe (Bepi) Colombo, que projetou a trajetória multi-sobrevoo da Mariner 10. O cruzeiro de 8 anos usa 9 assistências gravitacionais (Terra 2020, Vênus 2020, Vênus 2021, depois seis sobrevoos de Mercúrio 2021-2024) mais empuxo iônico-elétrico contínuo. Inserção em órbita mercuriana em 5-12-2026; operações científicas começam no início de 2027.',
    },
    ru: {
      name: 'БепиКоломбо',
      type: 'ОРБИТАЛЬНЫЙ · АКТИВНА',
      first: 'Первая совместная европейско-японская планетарная миссия; второй в истории аппарат на орбите Меркурия (после «Мессенджера»)',
      description: 'Совместная миссия ЕКА / JAXA к Меркурию, запущена 20.10.2018 — названа в честь итальянского математика Джузеппе (Бепи) Коломбо, спроектировавшего траекторию с множественными пролётами «Маринера-10». 8-летний перелёт использует 9 гравитационных манёвров (Земля 2020, Венера 2020, Венера 2021, затем шесть пролётов Меркурия 2021-2024) плюс непрерывную ионную электрическую тягу. Выход на орбиту Меркурия 5.12.2026; научные операции начинаются в начале 2027 года.',
    },
    'sr-Cyrl': {
      name: 'БепиКоломбо',
      type: 'ОРБИТЕР · АКТИВНА',
      first: 'Прва заједничка планетарна мисија Европе и Јапана; друга летелица икада која орбитира око Меркура (после Месинџера)',
      description: 'Заједничка ЕСА / ЈАКСА мисија ка Меркуру, лансирана 20.10.2018. — названа по италијанском математичару Ђузепеу (Бепи) Коломбу, који је дизајнирао Маринеру 10 путању са вишеструким прелетима. Осмогодишњи пут користи 9 гравитационих асистенција (Земља 2020, Венера 2020, Венера 2021, па шест Меркурових прелета 2021-2024) плус континуирани јонски-електрични погон. Улазак у Меркурову орбиту 5.12.2026; научне операције почињу почетком 2027.',
    },
    'zh-CN': {
      name: '贝皮科伦坡号',
      type: '轨道器 · 活跃',
      first: '欧洲与日本首次联合行星任务；史上第二个进入水星轨道的航天器（继信使号之后）',
      description: 'ESA / JAXA联合水星任务，2018-10-20发射 — 以设计了水手10号多次飞掠轨道的意大利数学家朱塞佩（贝皮）科伦坡命名。8年巡航使用9次引力辅助（地球2020、金星2020、金星2021，然后2021-2024年六次水星飞掠）加上连续的离子电推进。水星轨道进入定于2026-12-5；科学运作于2027年初开始。',
    },
  },
  ulysses: {
    ar: {
...
const COPLANAR_OVERLAYS = {
  ar: {
    ...
    intro_sentence: 'النظام الشمسي قرص، والوقود محدود — لذا المهمات لا تغادر القرص إلا إذا اضطُرت إلى ذلك.',
  },
  de: {
    title: 'Warum Missions-Trajektorien flach aussehen',
    intro_sentence: 'Das Sonnensystem ist eine Scheibe, und Treibstoff ist endlich — also verlassen Missionen die Scheibe nicht, es sei denn, sie müssen.',
  },
  es: {
    title: 'Por qué las trayectorias de misiones parecen planas',
    intro_sentence: 'El Sistema Solar es un disco, y el propulsor es finito — así que las misiones no abandonan el disco a menos que tengan que hacerlo.',
  },
  fr: {
    title: 'Pourquoi les trajectoires de mission paraissent plates',
    intro_sentence: 'Le Système solaire est un disque, et le carburant est limité — alors les missions ne quittent pas le disque à moins d\'y être contraintes.',
  },
  hi: {
    title: 'मिशन प्रक्षेपपथ सपाट क्यों दिखते हैं',
    intro_sentence: 'सौर मंडल एक डिस्क है, और प्रणोदक सीमित है — इसलिए मिशन तब तक डिस्क नहीं छोड़ते जब तक उन्हें ऐसा करना न पड़े।',
  },
  it: {
    title: 'Perché le traiettorie di missione sembrano piatte',
    intro_sentence: 'Il Sistema Solare è un disco, e il propellente è limitato — quindi le missioni non lasciano il disco a meno che non debbano.',
  },
  ja: {
    title: 'ミッション軌道が平らに見える理由',
    intro_sentence: '太陽系は円盤であり、推進剤は有限です — だからミッションは必要に迫られない限り円盤を離れません。',
  },
  ko: {
    title: '미션 궤적이 평평해 보이는 이유',
    intro_sentence: '태양계는 원반이고 추진제는 유한합니다 — 따라서 미션은 그래야만 하지 않는 한 원반을 떠나지 않습니다.',
  },
  nl: {
    title: 'Waarom missietrajecten plat lijken',
    intro_sentence: 'Het zonnestelsel is een schijf en stuwstof is eindig — dus missies verlaten de schijf niet tenzij het moet.',
  },
  'pt-BR': {
    title: 'Por que as trajetórias de missão parecem planas',
    intro_sentence: 'O Sistema Solar é um disco e o propelente é finito — então as missões não saem do disco a menos que precisem.',
  },
  ru: {
    title: 'Почему траектории миссий выглядят плоскими',
    intro_sentence: 'Солнечная система — это диск, а топливо ограничено — поэтому миссии не покидают диск, если только не обязаны.',
  },
  'sr-Cyrl': {
    title: 'Зашто се путање мисија чине равним',
    intro_sentence: 'Сунчев систем је диск, а гориво је ограничено — па мисије не напуштају диск осим ако не морају.',
  },
  'zh-CN': {
    title: '为什么任务轨迹看起来是平的',
...
console.log(`  - coplanar-trajectories science article × 13 locales × {title, intro_sentence}: 13 files`);
console.log('Skipped (English fallback):');
console.log('  - Mission events arrays (mostly universal date + place names)');
console.log('  - Coplanar-trajectories narrative_101 + body_paragraphs (substantial — needs native pass)');
