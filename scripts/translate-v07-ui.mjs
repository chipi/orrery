...
const KEYS = [
  // batch 7d — component a11y (aria-label / title / placeholder)
  'ui_close',
  'epoch_timeline_aria',
  'epoch_filter_aria',
  'launches_banner_aria',
  'observatory_showcase_aria',
  'hotspots_lod_title',
  'mission_open_in_fleet_title',
  'panorama_exit_title',
  'dropdown_filter_placeholder',
  'settings_aria',
  'settings_close_aria',
  'science_search_dialog_aria',
  'search_close_aria',
  'science_search_placeholder',
  'search_query_aria',
  'science_lens_aria',
  'science_layers_aria',
  'spacecraft_state_aria',
  'orbital_regime_aria',
  'assembly_reset_aria',
  'assembly_reset_title',
  'assembly_scrubber_aria',
  'assembly_close',
  'assembly_open_module_title',
  'source_open_new_tab_title',
  'timeline_current_year_aria',
];
