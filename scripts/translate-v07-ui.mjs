...
const KEYS = [
  // batch 7e — route-level a11y (aria-label / title)
  'footer_aria',
  'footer_links_aria',
  'footer_about_aria',
  'version_info_title',
  'landing_hero_aria',
  'credits_variants_aria',
  'explore_show_controls_aria',
  'explore_show_controls_title',
  'explore_hide_controls_aria',
  'explore_hide_controls_title',
  'explore_trajectory_legend_aria',
  'fleet_filters_aria',
  'fleet_category_aria',
  'fleet_status_aria',
  'fleet_agency_aria',
  ...
  'fleet_grid_aria',
  'fly_proceed_aria',
  'fly_science_lens_toggles_aria',
  'fly_toggle_flight_director_title',
  'fly_toggle_science_layers_title',
  'fly_toggle_conic_title',
  'fly_view_toggles_aria',
  'fly_toggle_hud_title',
  'fly_toggle_capcom_title',
  'fly_mission_arc_title',
  'timeline_close',
  'iss_toggle_timeline_aria',
  'iss_timeline_title',
  'iss_watch_assembly_title',
  'tiangong_toggle_timeline_aria',
  'tiangong_timeline_title',
  'tiangong_watch_assembly_title',
  'library_transcripts_aria',
  'library_launches_sources_aria',
  'plan_porkchop_title',
  'science_focused_101_aria',
  'science_focused_101_tab_aria',
  'science_tabs_aria',
  'science_search_kbd_aria',
  'science_sections_tab_aria',
];
