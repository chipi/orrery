...
export const ALLOWLIST: ReadonlySet<string> = new Set<string>([
  ...
  // ── Slice A re-source (2026-06-17) — agency primary returned the same
  //    image for multiple slots of a mission (thin photographic record),
  //    or for both fleet and missions surface entries of the same
  //    mission (legit cross-surface reuse). Per-slot variety queries
  //    deferred to v0.8 — see GH #350.
  '00f2e8f0',
  '01722ba6',
  '0dc2596c',
  '0fc3b68a',
