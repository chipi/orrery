...
const COASTS: Record<string, EarthOrbitCoast> = {
  ...
  apollo9: {
    ...
    inclinationDeg: 33.8,
    revolutions: 151,
    coastDurationS: 907200,
  },
  'apollo-soyuz': {
    missionId: 'apollo-soyuz',
    capsuleId: 'apollo-cm',
    apogeeKm: 222,
    perigeeKm: 217,
    inclinationDeg: 51.8,
    revolutions: 148,
    coastDurationS: 783000,
  },
  'skylab-2': {
    missionId: 'skylab-2',
    capsuleId: 'apollo-cm',
  ...
  'soyuz-11': {
    ...
    inclinationDeg: 51.6,
    revolutions: 383,
    coastDurationS: 2053000,
  },
  inspiration4: {
    missionId: 'inspiration4',
    capsuleId: 'dragon',
    apogeeKm: 585,
    perigeeKm: 575,
    inclinationDeg: 51.6,
    revolutions: 47,
    coastDurationS: 250000,
  },
  'polaris-dawn': {
    missionId: 'polaris-dawn',
    capsuleId: 'dragon',
    apogeeKm: 1400,
    perigeeKm: 190,
    inclinationDeg: 51.7,
