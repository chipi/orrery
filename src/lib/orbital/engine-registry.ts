...
export const ENGINE_REGISTRY: EngineMeta[] = [
  {
    ...
    mass_kg: 8400,
    designations: ['F-1'],
    science: ['propulsion/rocket-equation', 'propulsion/thrust'],
    links: [
  ...
  },
  {
    ...
    mass_kg: 3527,
    designations: ['RS-25'],
    science: ['propulsion/staged-combustion', 'propulsion/specific-impulse'],
  ...
  },
  {
    ...
    science: ['propulsion/expander-cycle'],
  ...
  },
  {
    ...
    mass_kg: 5480,
    designations: ['RD-180'],
    science: ['propulsion/staged-combustion'],
