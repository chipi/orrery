...
export const ENGINE_REGISTRY: EngineMeta[] = [
  ...
  },
  {
    ...
    cycle: 'expander',
    propellant: 'LOX / LH2',
    thrust_kn: 101.8, // RL10C-1 (coherent variant row — B-2's 110 kN/301 kg mixed variants)
    thrustNote: 'vacuum',
    isp_vac_s: 449.7,
    mass_kg: 190,
  ...
  },
  {
    ...
    country: 'USA',
    manufacturer: 'SpaceX',
    first_flight: '2019-07-25', // Starhopper free flight — the first FFSC engine to fly
    status: 'ACTIVE',
    era: '2011-now',
    epoch: 'mars-era',
  ...
  },
  {
    ...
    thrust_kn: 839,
    thrustNote: 'sea level',
    isp_sl_s: 263.3, // RD-107A (matches the A-variant designations below)
    isp_vac_s: 320.2,
  ...
  },
  {
    ...
    status: 'ACTIVE', // production/deliveries ended; Atlas V still flying down its manifest
    era: '1981-2011',
    epoch: 'iss-assembly',
    best_known_for: 'Oxygen-rich staged combustion the US could not match — flies on Atlas V',
  ...
  },
  {
    ...
    era: '1981-2011',
    epoch: 'iss-assembly',
    best_known_for: "Europe's hydrogen core engine — powered Ariane 5 ECA",
    cycle: 'gas-generator',
    propellant: 'LOX / LH2',
    thrust_kn: 1359,
    thrustNote: 'vacuum',
  ...
  },
  {
    ...
    first_flight: '1962-03-16', // Titan II — the hypergolic LR87-AJ-5 this row describes (Titan I's 1959 LR87 burned LOX/RP-1)
