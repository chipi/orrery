...
export const reachTheMoon: Goal = {
  ...
  connection: {
    ...
    links: [
      ...
      { labelKey: 'lab.conn.rtm.saturn', href: '/fleet?id=saturn-v', agency: 'NASA' },
      { labelKey: 'lab.conn.rtm.csm', href: '/fleet?id=apollo-csm-block-ii', agency: 'NASA' },
...
export const leaveTheSolarSystem: Goal = {
  ...
  connection: {
    ...
    links: [
      ...
      { labelKey: 'lab.conn.lss.voyager1craft', href: '/fleet?id=voyager-1', agency: 'NASA' },
      { labelKey: 'lab.conn.lss.voyager2craft', href: '/fleet?id=voyager-2', agency: 'NASA' },
    ],
  },
};
...
export const apolloRoundTrip: Goal = {
  ...
  connection: {
    ...
    links: [
      ...
      { labelKey: 'lab.conn.art.apollo13', href: '/fly?mission=apollo13', agency: 'NASA' },
      { labelKey: 'lab.conn.art.saturn', href: '/fleet?id=saturn-v', agency: 'NASA' },
      { labelKey: 'lab.conn.art.csm', href: '/fleet?id=apollo-csm-block-ii', agency: 'NASA' },
