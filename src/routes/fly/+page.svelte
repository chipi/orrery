  ...
  onMount(() => {
    ...
    const loop = createAnimateLoop({
      onFrame: () => {
        ...
        if (!isMoonMission && flyCam.montageShotFrame) {
          ...
          const isCut = flyCam.montageShotKind !== lastMontageShotKind;
          lastMontageShotKind = flyCam.montageShotKind;
        ...
        if (import.meta.env.DEV) {
          ...
          if (debugMontageShot !== flyCam.montageShotKind)
            debugMontageShot = flyCam.montageShotKind;
        }
