...
const PROGRAM_IDS = ['apollo', 'mercury', 'gemini', 'vostok', 'voskhod', 'soyuz', 'soviet-lunar', 'skylab', 'salyut', 'mir', 'space-shuttle', 'buran', 'ariane', 'esa-human', 'iss', 'tiangong', 'shenzhou'];
