...
const PROGRAM_IDS = ['apollo', 'mercury', 'gemini', 'vostok', 'voskhod', 'soyuz', 'soviet-lunar', 'skylab', 'salyut', 'mir', 'space-shuttle', 'buran', 'ariane', 'esa-human', 'iss', 'tiangong', 'shenzhou', 'spacex', 'starlink', 'starship', 'kuiper', 'artemis', 'hayabusa', 'jaxa-robotic', 'chandrayaan', 'mangalyaan', 'great-observatories', 'jwst', 'gaganyaan', 'esa-science'];
