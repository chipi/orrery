<!--
  ...
  Two-column layout on desktop: a sticky left rail with the six
  encyclopedia tabs, vertically stacked, alongside an editorial
  "Space 101" narrative that walks a curious newcomer through how
  rockets actually reach the Moon or Mars. Every italic technical
  term cross-links into the matching section, and the closing
  tools panel links into the live app routes. On mobile the rail
  collapses above the story.
-->
<script lang="ts">
    ...
    <article class="story">
      <section class="chapter">
        ...
        <p class="kicker">
          ...
          section explains where it comes from. Read it like a comic book: the diagrams do most of
          the work, and every <em>italicised term</em> is a link you can chase as deep as you want.
        </p>
        <p>
          We're going to build a rocket together. Not a literal one — Orrery is a simulator — but
          the same chain of decisions a real flight team makes, in the order they'd make them. By
          the end you'll know why launch windows happen every 26 months for Mars and every month for
          the Moon, why a free-return trajectory exists, and why
      ...
      <section class="chapter">
        ...
        <p>
          ...
          <em>so</em> hard that the ground curves away faster than the ball falls, and the ball
          misses the planet — forever. That's an
      ...
      <section class="chapter">
        ...
        <p>
          ...
          <a href="{base}/science/propulsion/dv-budget">∆v</a> ("delta-v") is the universal currency
          of spaceflight — the total velocity change a mission needs. Every move you make on a trajectory
        ...
        <p>
          ...
          <em>efficiently</em> the engine pushes — and that's the one that matters. A chemical rocket
          gets ~450 seconds. An ion thruster gets 4,000+ — sips fuel for months and outperforms anything
          chemical for deep-space cruises.
        </p>
        <p>
          ...
          <em>way</em> more bang for the same fuel. This is why every interplanetary mission does its
          big departure burn at perigee, hugging the Earth, going as fast as physics allows. Free energy
          from geometry.
        </p>
      </section>
      ...
      <section class="chapter">
        ...
        <p>
          ...
          system." He wasn't kidding. Reaching low Earth orbit costs ~9.4 km/s of ∆v. Going from
          there to <em>Mars</em> costs another ~3.6 km/s. The hardest part is already behind you.
        </p>
        <p>
        ...
        <p>
          ...
          <a href="{base}/science/transfers/transfer-ellipse">transfer ellipse</a> that connects
          them. That's exactly what Orrery's
        ...
        <p>
          ...
          <a href="{base}/science/transfers/gravity-assist">gravity assist</a> uses a flyby to
          change your trajectory at zero fuel cost — Voyager 2 used four of them to reach Neptune.
          The whole solar system stitches together as
          <a href="{base}/science/transfers/patched-conics">patched conics</a>: a series of
          <a href="{base}/science/transfers/conic-sections">conic-section</a> arcs handed off between
          gravitational neighbourhoods like batons in a relay race.
        </p>
      </section>
      ...
      <section class="chapter">
        ...
        <p>
          The <a href="{base}/science/porkchop/what-is-a-porkchop">porkchop plot</a> is how
          engineers see this. Departure date along
          ...
          <a href="{base}/science/porkchop/dv-heatmap">colour heatmap</a>. Cheap zones appear as
          oval lobes — the launch windows. Outside the lobe: red, expensive,
      ...
      <section class="chapter">
        ...
        <ol class="phases">
          <li>
            <a href="{base}/science/mission-phases/launch">Launch</a> — get out of the atmosphere and
        ...
        <p>
          ...
          that drop you back to Earth automatically if every engine on the spacecraft dies. Apollo 13
          owes its life to this geometry.
        </p>
      </section>
      ...
      <section class="chapter">
        ...
        <figure class="story-fig">
          ...
          />
          <figcaption>
            One AU = one Earth-Sun distance. Mars is ~1.5 AU. Jupiter is ~5.2.
          </figcaption>
        </figure>
        <p>
          Three units pop up everywhere. The
          <a href="{base}/science/scales-time/au">astronomical unit</a> (AU) is the average
          Earth-Sun distance — 150 million km. We measure the solar system in AU because kilometres
          get unwieldy fast. The
        ...
        <p>
          ...
          <a href="{base}/science/scales-time/ecliptic-plane">ecliptic plane</a> is the flat disc
          the planets all (mostly) lie on.
          <a href="{base}/science/scales-time/frames">Reference frames</a> are the coordinate systems
          mission control juggles between Earth-centred, Sun-centred, and body-centred views.
        </p>
      </section>
      ...
      <section class="chapter">
        <h2>Now go play.</h2>
        <p>
          That's the whole loop. You now know enough to read every label, contour, and HUD readout
          in the rest of the app. Here's where to put it to work:
        </p>
        <ul class="tools">
          <li>
            <a href="{base}/explore">/explore</a> — Spin the solar system. Watch Kepler's laws live.
            Click any planet for its orbital elements.
          </li>
          <li>
          ...
          <li>
            <a href="{base}/missions">/missions</a> — 36 real spacecraft, from Luna 9 to Artemis II.
            Each one's FLIGHT tab decomposes its actual ∆v budget across the phases above.
          </li>
          <li>
        ...
        <p class="closing">
          Below this story, the encyclopedia proper: six tabs, forty entries, every formula and
          every diagram in one place. Bookmark it. We'll be here when you need it.
        </p>
      </section>
    </article>
  </div>
