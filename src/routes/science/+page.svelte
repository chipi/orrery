<!--
  /science — encyclopedia tab index landing. The shared sticky rail
  with the six tabs lives in +layout.svelte; this route renders the
  editorial "Space 101" narrative on the right column. Every italic
  technical term cross-links into the matching section, and the
  closing tools panel links into the live app routes.
-->
<script lang="ts">
...
<article class="story">
  ...
  <section class="chapter">
    ...
    <p>
      Forget rockets for a second. Stand on the Earth, throw a baseball as hard as you can. It comes
      back down. Throw it harder, it lands farther. Throw it
    ...
    <p>
      ...
      ellipse the spacecraft is right now (<a href="{base}/science/orbits/true-anomaly"
        >true anomaly</a
      >). Five numbers and you can predict the position of any object in the solar system, forever,
      without any other data. That's
    ...
    <p>
      ...
      <a href="{base}/science/orbits/vis-viva">vis-viva</a>. Plug in your radius, your orbit's size,
      and out comes your speed. That's it. Earth at perihelion: 30.3 km/s. Earth at aphelion: 29.3
      km/s. Same orbit, same energy, different speed.
    </p>
  </section>
  ...
  <section class="chapter">
    ...
    <p>
      ...
      <a href="{base}/science/propulsion/dv-budget">∆v</a> ("delta-v") is the universal currency of spaceflight
      — the total velocity change a mission needs. Every move you make on a trajectory has a price tag
      in km/s.
    </p>
    <p>
      And that price is brutal. The
      <a href="{base}/science/propulsion/tsiolkovsky">Tsiolkovsky rocket equation</a> says ∆v scales
      with the <em>logarithm</em> of how much of your rocket is fuel. Want twice the ∆v? You don't carry
      twice the fuel — you carry exponentially more. This is why a Saturn V was 90% propellant. Most
      of the rocket is the fuel that lifts the fuel that lifts the fuel that lifts the spacecraft.
    </p>
    <p>
    ...
    <p>
      ...
      <a href="{base}/science/propulsion/oberth-effect">Oberth effect</a>. Burning your engine when
      you're already moving fast (low and close to a planet) gives you
  ...
  <section class="chapter">
    ...
    <p>
      ...
      <a href="{base}/science/transfers/hohmann-transfer">Hohmann transfer</a>: an ellipse that just
      barely kisses Earth's orbit at one end and the destination's orbit at the other. Two burns, no
      wasted fuel. To Mars it takes ~8.5 months. Slow, but optimal.
    </p>
    <p>
      Want to go faster? Solve a
      <a href="{base}/science/transfers/lambert-problem">Lambert's problem</a> — pick your departure
      date and your transit time, and Lambert tells you the unique
  ...
  <section class="chapter">
    ...
    <p>
      ...
      Their relative geometry repeats only every ~26 months — and most of those months, the planets
      are too far apart, on the wrong sides of the Sun, to reach cheaply. Mission design starts with
      a calendar, not a rocket.
    </p>
    <p>
      ...
      lobes — the launch windows. Outside the lobe: red, expensive, impossible-with-current-rockets.
    ...
    <p>
      ...
      <a href="{base}/science/propulsion/c3">C3</a> is the launch energy your rocket needs to leave
      Earth's gravity well. <a href="{base}/science/propulsion/v-infinity">V∞</a>
      ("v-infinity") is your speed relative to the destination at the moment you arrive. Both come straight
      out of the porkchop math.
    </p>
  </section>
  ...
  <section class="chapter">
    ...
    <ol class="phases">
      ...
      <li>
        <a href="{base}/science/mission-phases/trans-x-injection">Trans-X Injection</a> — a single hard
        burn at perigee that flings you onto the transfer ellipse to the Moon (TLI), Mars (TMI), Venus
        (TVI), or Jupiter (TJI).
      </li>
      <li>
    ...
    <p>
      ...
      <a href="{base}/science/transfers/free-return">free-return trajectories</a> — figure-8 paths that
      drop you back to Earth automatically if every engine on the spacecraft dies. Apollo 13 owes its
      life to this geometry.
    </p>
  </section>
  ...
  <section class="chapter">
    ...
    <ul class="tools">
      ...
      <li>
        <a href="{base}/plan">/plan</a> — Pick a destination, pick a launch year, see the porkchop. The
        lobe is where Hohmann transfers hide.
      </li>
      <li>
        <a href="{base}/fly">/fly</a> — Fly a real mission arc. The HUD shows ∆v, V∞, MET, distance to
        Earth. Every number is something you just learned.
      </li>
      <li>
      ...
      <li>
        <a href="{base}/iss">/iss</a> · <a href="{base}/tiangong">/tiangong</a> — The two inhabited orbital
        outposts, module by module.
      </li>
    </ul>
    <p class="closing">
